        ...
        <div className="flex lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="flex-grow flex flex-wrap justify-center -mb-10 md:mt-0 mt-10 text-center">
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              <div className="footer-title font-semibold text-base-content tracking-widest text-sm md:text-left mb-3">JOB SEEKERS</div>
              <div className="flex flex-col justify-center items-center md:items-start gap-2 mb-10 text-sm">
                <Link href="/jobs" className="link link-hover">Browse Jobs</Link>
                <Link href="/fractional-coo-jobs" className="link link-hover">Fractional COO Jobs</Link>
                <Link href="/fractional-cmo-jobs" className="link link-hover">Fractional CMO Jobs</Link>
                <Link href="/fractional-cfo-jobs" className="link link-hover">Fractional CFO Jobs</Link>
            ...
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              <div className="footer-title font-semibold text-base-content tracking-widest text-sm md:text-left mb-3">EMPLOYERS</div>
              <div className="flex flex-col justify-center items-center md:items-start gap-2 mb-10 text-sm">
                <Link href="/post-a-job" className="link link-hover">Post a Job</Link>
                <Link href="/blog" className="link link-hover">Blog</Link>
                <Link href="/about" className="link link-hover">About</Link>
                {config.resend.supportEmail && (
                  <a href={`mailto:${config.resend.supportEmail}`} target="_blank" className="link link-hover">Contact</a>
                )}
              </div>
            </div>
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
